...
namespace SpecialLogisticsSystem.UserControl
{
    ...
    public class RowCheckBoxFunction
    {
        public static void _sgv_RowCheckBox(ASPxGridView _sgv,EventArgs e)
        {
            ...
            commandColumn.HeaderTemplate = new HeaderTemplate(_sgv);
    ...
    {
        ASPxGridView _sgv;
        public HeaderTemplate(ASPxGridView sgv)
        {
            _sgv = sgv;
        }
        public void InstantiateIn(Control container)
        {
            ...
            chooseAll.JSProperties["cpClientInstanceName"] = _sgv.ClientInstanceName;
