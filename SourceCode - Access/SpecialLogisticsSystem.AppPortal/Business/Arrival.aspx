...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function filterCondition() {
            return { way_number: txt_way_number.GetValue(), receive_date_start: receive_date_start.lastSuccessText, receive_date_end: receive_date_end.lastSuccessText,bill_statue:cmbWayStatue.GetValue(), is_hide:0 };
        }
    </script>
