<%@ Page Title="" Language="C#" MasterPageFile="~/MenuMaster.Master" AutoEventWireup="true" CodeBehind="CustomerPay.aspx.cs" Inherits="SpecialLogisticsSystem.AppPortal.Finance.CustomerPay" %>
<%@ Register Src="/UserControls/CustomerPayDetail.ascx" TagName="CustomerPayDetail" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function filterCondition() {
            return { way_number: txt_way_number.GetValue(), receive_date_start: receive_date_start.lastSuccessText
            , receive_date_end: receive_date_end.lastSuccessText,settle_name:com_settle_statue.GetText() };
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
  <cx:ASPxGridView ID="gridWay" runat="server" 
        ...
        <Columns>
			...
			<dx:GridViewDataTextColumn Caption="结算状态" FieldName="settle_name" Width="60">
            </dx:GridViewDataTextColumn>
			<dx:GridViewDataTextColumn Caption="总金额" FieldName="aggregate_amount" Width="80">
            </dx:GridViewDataTextColumn>
			...
			<EditForm>
				...
				<table cellpadding="4" cellspacing="0" class="editTable">
					...
					<tr>
						...
						<td class="editFormCell">
							<cx:ASPxTextBox ID="aggregate_amount" runat="server" Width="120"  IsPrice="true" IsReadOnly="true">
							</cx:ASPxTextBox>
						</td>
						<td class="editFormCaption">
							现付:
						...
						<td class="editFormCell">
							<cx:ASPxTextBox ID="spot_payment" runat="server" Width="120" IsPrice="true" IsReadOnly="true">
							</cx:ASPxTextBox>
						</td>
					</tr>
					<tr>
						...
						<td class="editFormCell">
							<cx:ASPxTextBox ID="back_payment" runat="server" Width="120" IsPrice="true" IsReadOnly="true">
							</cx:ASPxTextBox>
						</td>
						<td class="editFormCaption">
						...
						<td class="editFormCell">
							<cx:ASPxTextBox ID="settle_accounts" runat="server" Width="120" IsPrice="true" IsReadOnly="true">
							</cx:ASPxTextBox>
						</td>
					</tr>
					<tr>
						<td class="editFormCaption">
							实结金额<span class="red">*</span>:
						</td>
						<td class="editFormCell">
							<cx:ASPxTextBox ID="real_payment" runat="server" Width="120" IsPrice="true">
							</cx:ASPxTextBox>
						</td>
						<td class="editFormCaption">
							结算方式:
						...
						<td class="editFormCell">
							 <dx:ComoboxCode ID="settle_mode" runat="server" CodeType="finance_settle_type" Width="120"  Index="1"></dx:ComoboxCode>
						</td>
					</tr>
					<tr>
						<td class="editFormCaption">
						...
						<td class="editFormCell">
							<cx:ASPxDateEdit ID="collection_day" runat="server" Width="120" DefaultToday="true">
							</cx:ASPxDateEdit>
						</td>
					</tr>
					<tr>
		...
		<SettingsText PopupEditFormCaption="客户结算" />
	...
	<uc1:CustomerPayDetail ID="customerPayDetail" runat="server"></uc1:CustomerPayDetail>
	<asp:ObjectDataSource ID="wayDataSource" runat="server" TypeName="SpecialLogisticsSystem.AppPortal.UIHelpers.FinanceCustomer"
