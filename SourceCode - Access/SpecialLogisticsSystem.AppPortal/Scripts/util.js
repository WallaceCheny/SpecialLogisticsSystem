...
//                            }
//                        }
//                        addTab("", unescape(menuname) + ' - 帮助', url.replace("aspx", "htm").replace("Business", "Videos"), 'frame', 'help');
//                    }
//                }
//            }
//        });
        var url = location.pathname.replace("aspx", "htm").replace("Business", "WebSite/ShowVideos");
        window.open(url, "视频", "", "");
    },
