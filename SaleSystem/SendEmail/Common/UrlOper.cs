...
namespace Common
{
    ...
    public class UrlOper
    {
        ...
        /// <summary>
        /// Get the all virtual path, like http://www.XXX.com
        /// </summary>
        public static string GetUrl()
        {
            HttpRequest request = HttpContext.Current.Request;
            int index = request.Url.AbsoluteUri.LastIndexOf(request.Url.AbsolutePath);
            string _ApplicationPath = request.Url.AbsoluteUri.Substring(0, index) + request.ApplicationPath;
            ...
            {
                _ApplicationPath = _ApplicationPath.Substring(0, _ApplicationPath.Length - 1);
            }
